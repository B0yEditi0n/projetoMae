      ...
      body: SingleChildScrollView(
        child: Center(
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                 Image.asset("lib/imagens/pixSupportUs.jfif", scale: 1.8, fit: BoxFit.fitWidth),
                //Espaço entre entre barra e o icone
                const SizedBox(height: 30),
                textoTitulo('Colabore com qualquer valor!', Colors.white),
                const SizedBox(height: 20),
                textoPadrao('Ajude-nos a terminar o nosso projeto extremamente caro doando um valor simbólico. Você estará dando visibilidade para desenvolvedores pequenos', Colors.grey),
